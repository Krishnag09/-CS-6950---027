...
for x in range (5, project_index_pages1+1):
    print x
    ...
    #projectlink= driver.find_elements_by_css_selector ('a.project-thumbnail-wrap')
    #projectlink= driver.find_elements_by_css_selector('div.project-thumbnail')
    #projectlink= driver.find_elements_by_css_selector('#projects_list > div:nth-child(3) > li:nth-child(4) > div > div.project-thumbnail > a')
    #projectlink= driver.find_elements_by_css_selector('div.project-profile-title')
    projectlink= driver.find_elements_by_css_selector('h6.project-title')
    links= []
    for title in projectlink:
        link= title.find_element_by_css_selector('a').get_attribute('href')
        link= str(link)
        link1= link.split('?', 1)[0]
        links.append(link1)
        print link
        print title.text
    i=0
    for link in links[16:]:
        ...
        #project_name= driver.find_element_by_css_selector('a.hero__link').text works only for successful campaigns
        ...
        short_description= driver.find_element_by_css_selector('p.h3.mb3').text # works for ongoing and unsuccessful    
        #short_description=driver.find_element_by_css_selector('h3.normal').text
        #short_description= driver.find_element_by_css_selector('span.content.edit-profile-blurb.js-edit-profile-blurb').text #only for the successful
        print short_description
        #category= driver.find_element_by_xpath('//*[@id="content-wrap"]/div[2]/section[1]/div/div/div/div/div[1]/div[1]/div[2]/div[1]/div/div/a[2]').text #works for successful
        ...
        #raisedmoney= driver.find_element_by_css_selector('h3.mb1').text #works for the successful
        raisedmoney= driver.find_element_by_css_selector('div#pledged.num.h1.bold.nowrap').text
        goalmoney= driver.find_element_by_xpath("//*[contains(text(), 'pledged of')]").text
        status= driver.find_element_by_css_selector('h3.normal.mb1').text
